...
init python:
    ...
    splash_message_default = "Infinite Poems Mods by Escartem"
...
label splashscreen:
    ...
    if not persistent.first_run:
        ...
        "Thanks for installing [config.name] !"

        menu:
            "Do you agree that you have completed Doki Doki Literature Club and accept any spoilers contained within."
            "I agree.":
